				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<div class="row youplay-side-news <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					  ...
					  <div class="col-xs-9 col-md-8">
					    <?php
					    echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf( '<a href="%s" style="text-decoration: none;" class="pull-right mr-10 remove_from_cart_button" aria-label="%s" data-product_id="%s" ata-cart_item_key="%s" data-product_sku="%s"><i class="fa fa-times"></i></a>',
					    ...
					    <h4 class="ellipsis"><a href="<?php echo esc_url($product_permalink); ?>" title="<?php echo esc_attr($product_name); ?>"><?php echo esc_html( $product_name ); ?></a></h4>
