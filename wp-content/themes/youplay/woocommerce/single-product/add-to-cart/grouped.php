...
<form class="cart grouped_form" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
	<table cellspacing="0" class="group_table">
		<tbody>
            ...
            foreach ( $grouped_products as $grouped_product_child ) {
                ...
                echo '<tr id="product-' . esc_attr( $grouped_product_child->get_id() ) . '" class="' . esc_attr( implode( ' ', wc_get_product_class( '', $grouped_product_child->get_id() ) ) ) . '">';
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="btn btn-default btn-lg ml-0 mt-20"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
