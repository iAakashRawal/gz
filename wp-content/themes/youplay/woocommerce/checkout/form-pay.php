...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php esc_html_e( 'Product', 'youplay' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'youplay' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'youplay' ); ?></th>
			</tr>
		</thead>
		<tbody>
	...
	<div id="payment">
		...
		<div class="form-row">
            ...
            <?php echo apply_filters( 'woocommerce_pay_order_button_html', '<button type="submit" class="btn btn-default pull-right" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '">' . esc_html( $order_button_text ) . '</button>' ); // @codingStandardsIgnoreLine ?>
