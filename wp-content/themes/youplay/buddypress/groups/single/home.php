	...
	<div id="item-body">
		 ...
		 */
			...
			// Not looking at home
				...
				// Group Members
				elseif ( bp_is_group_members()    ) : youplay_bp_groups_members_template_part();

				// Group Invitations
				elseif ( bp_is_group_invites()    ) : bp_get_template_part( 'groups/single/send-invites' );

				// Old group forums
				elseif ( function_exists('bp_is_group_forum') && bp_is_group_forum() ) : bp_get_template_part( 'groups/single/forum' );
