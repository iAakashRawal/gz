 ...
 * @extends  WC_Widget
 */
class yp_WC_Widget_Recently_Viewed extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Display a list of recently viewed products.', 'youplay-core' );
		$this->widget_id          = 'woocommerce_recently_viewed_products';
		$this->widget_name        = __( 'WooCommerce Recently Viewed', 'youplay-core' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Recently Viewed Products', 'youplay-core' ),
	...
	function widget( $args, $instance ) {
        ...
        // NOTE: added wp_kses_post to prevent theme check warning
