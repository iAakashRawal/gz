    ...
    init: function init(editor, url) {
      editor.addButton('yp_button', {
        ...
        onclick: function onclick() {
          editor.execCommand('mceInsertContent', false, '[yp_button href="https://nkdev.info" target="_self" rel="" size="lg" full_width="false" active="false" color="success" icon_before="fa fa-html5" icon_after=""]Youplay[/yp_button]');
        }
      });
    },
